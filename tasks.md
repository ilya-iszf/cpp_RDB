# Важное замечание: выполняйте задания [по стандартам оформления кода в С++](https://tproger.ru/translations/stanford-cpp-style-guide/). Небрежно оформленные задания не засчитываются.
